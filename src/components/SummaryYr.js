...
export default function Summary() {
  ...
  const selectedPlanPriceMobile = selectedPlanPrice;
  ...
  const sumOfIntegers = selectedProducts && selectedPlanPrice ? selectedProducts.reduce(
        ...
        <div className="mx-auto w-3/5 p-5 ">
          ...
          <div className=' relative px-1.5 rounded-2xl bg-neutral-magnolia'>
            <div className=' flex h-15 w-full pt-4 px-2'>
              <div>
                <h1 className='text-primary-marineblue font-semibold text-lg'>{selectedPlan} (Yearly)</h1>
                <Link onClick={prev} className='underline'> Change </Link>
              </div>
              <h1 className='absolute right-5 text-primary-marineblue font-semibold text-lg'> +${selectedPlanPrice}/yr </h1>
            </div>
              ...
              {selectedProducts.map((product) => (
                <div key={product.id} >
                  <div className="flex px-1.5 mt-2.5 mb-4 pb-2">
                    ...
                    <h2 className='absolute right-5 text-primary-marineblue font-semibold text-base'> +${product.price}/yr </h2>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className=' flex px-5 my-5'>
            ...
            <h1 className='absolute right-14 text-primary-purplishblue font-bold text-2xl'> ${sumOfIntegers}/yr </h1>
          </div>
            ...
            <div className={`flex flex-col mt-11`}>
              <div className=' relative px-1.5 rounded-2xl bg-neutral-magnolia'>
                <div className=' flex h-15 w-full pt-4 px-2'>
                  ...
                  <h1 className='absolute right-5 text-primary-marineblue font-semibold text-lg'> +${selectedPlanPriceMobile}/yr </h1>
                </div>
                <div className='border-2 mx-9 my-3'> </div>
                <div className="  w-4/5">
                  {selectedProducts.map((product) => (
    ...
    {/* <div className='lg:hidden '>
        ...
        >
          ...
          <div className=" rounded-lg p-4 mx-11 my-24 bg-white ">
            ...
            <div className=" px-20 w-96 h-12  my-11 mx-auto bg-neutral-magnolia rounded-lg ">
              {isText1Active ? (
