...
export default function AddOnsYr() {
    ...
    const products = [
        { id: 1, name: 'Online service', price: 10, description: 'Access to multiplayer games' },
        { id: 2, name: 'Larger storage', price: 20, description: 'Extra 1 TB of cloud save' },
        { id: 3, name: 'Customizable profile', price: 20, description: 'Custom theme on your profile' },
    ].map((product) => ({
        ...product,
        selected: false,
    }));
                    ...
                    <div >
                        {products.map((product) => (
                            ...
                            >
                                ...
                                <h3 className="absolute right-4 bottom-1 my-5 text-primary-purplishblue font-semibold"> +${product.price}/yr</h3>
                            </div>
                        ))}
                    </div>
                        ...
                        <div >
                            {products.map((product) => (
                                ...
                                >
                                    ...
                                    <h3 className="absolute right-4 my-5 text-primary-purplishblue font-semibold ml-5"> +${product.price}/yr </h3>
                                </div>
                            ))}
